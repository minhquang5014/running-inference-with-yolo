...
# ov_model = YOLO("best2_openvino_model/")
# result = ov_model("00164_jpg.rf.1e0223b44cbc5b80aafcd64cb729070b.jpg")
...
class ObjectDetection:
    ...
    def load_model(self):
        model = YOLO("best2_openvino_model/")
        model.fuse()
        return model
...
detector = ObjectDetection("video/video_07332025_11h33m31s.avi")
